...
## Modellfamilie{#id-modellfamilie}
...
Führen Sie obige Überlegung für den Fall $L´(w_0) > 0$ durch. Wie seht dann $w_1$ aus?



## Optimales Modell mit Python

Wir können die optimalen Paramater (relativ) einfach berechnen lassen. Das Ergebnis ist: 

![Optimale Modellparameter und MSE für "Grillen"](assets/16-regression-grillen.assets/image-20211205175741435.png){width=50%}
...
![Optimales Modell (d.h. optimale Gerade)](assets/16-regression-grillen.assets/image-20211205180928324.png){width=100%}
