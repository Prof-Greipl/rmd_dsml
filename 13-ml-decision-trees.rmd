...
![image-20211205130427796](assets/13-ml-decision-trees.assets/image-20211205130427796.png){width=100%}
...
![image-20211205144252174](assets/13-ml-decision-trees.assets/image-20211205144252174.png){width=100%}
...
- welche Klasse sie jeweils hatten (damit entsteht in dem Knoten eine *Zerlegung* der Menge; wir brauchen den Begriff weiter unten).
...
![image-20211203200915482](assets/13-ml-decision-trees.assets/image-20211203200915482.png){width=100%}
...
Wir berechnen den besten Baum mit Python. Hier das Ergebnis, unten der Code.
  ...
  ![Iris mit 2 Klassen: Optimaler Baum der Höhe 1](assets/13-ml-decision-trees.assets/image-20211129092942002.png){width=100%}
...
![image-20211202184650173](assets/13-ml-decision-trees.assets/image-20211202184650173.png){width=100%}
...
![GINI in Abhängigkeit von p](assets/13-ml-decision-trees.assets/image-20211202184126689.png

![GINI-Plot für $k=2$](assets/13-ml-decision-trees.assets/image-20211202184254174.png){width=50%}
...
![image-20211202185542367](assets/13-ml-decision-trees.assets/image-20211202185542367.png){width=100%} 
...
![image-20211205140552086](assets/13-ml-decision-trees.assets/image-20211205140552086.png){width=100%}
...
![image-20211205142457813](assets/13-ml-decision-trees.assets/image-20211205142457813.png){width=100%}
